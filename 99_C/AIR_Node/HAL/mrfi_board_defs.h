...
#define MRFI_CONFIG_GDO2_PIN_AS_INPUT()       st(P6SEL &= ~BV(__mrfi_GDO2_BIT__);) /* clear pin special function default */
#define MRFI_GDO2_PIN_IS_HIGH()                 (P6IN & BV(__mrfi_GDO2_BIT__))

//#define MRFI_GDO2_INT_VECTOR                  PORT6_VECTOR
//#define MRFI_ENABLE_GDO2_INT()                st( P6IE  |=  BV(__mrfi_GDO2_BIT__); ) /* atomic operation */
//#define MRFI_DISABLE_GDO2_INT()               st( P6IE  &= ~BV(__mrfi_GDO2_BIT__); ) /* atomic operation */
//#define MRFI_GDO2_INT_IS_ENABLED()              (  P6IE  &   BV(__mrfi_GDO2_BIT__) )
//#define MRFI_CLEAR_GDO2_INT_FLAG()            st( P6IFG &= ~BV(__mrfi_GDO2_BIT__); ) /* atomic operation */
//#define MRFI_GDO2_INT_FLAG_IS_SET()             (  P6IFG &   BV(__mrfi_GDO2_BIT__) )
//#define MRFI_CONFIG_GDO2_RISING_EDGE_INT()    st( P6IES &= ~BV(__mrfi_GDO2_BIT__); ) /* atomic operation */
//#define MRFI_CONFIG_GDO2_FALLING_EDGE_INT()   st( P6IES |=  BV(__mrfi_GDO2_BIT__); ) /* atomic operation */
...
#define MRFI_SPI_CONFIG_CSN_PIN_AS_OUTPUT()   st(P2DIR |=  BV(__mrfi_SPI_CSN_GPIO_BIT__); P2SEL &=  ~BV(__mrfi_SPI_CSN_GPIO_BIT__);)
